...
def main():
    ...
    if level == "yellow":
        ...
        tg_send(
            "🚨 <b>УВАГА! РАКЕТНА НЕБЕЗПЕКА!</b> 🚨\n\n"
            "У Березівській громаді оголошено підвищений рівень повітряної загрози.\n\n"
            "🔴 Ракетна небезпека! Негайно прямуйте до укриття та не залишайте його до офіційного відбою.\n\n"
        ...
        if prev in ("yellow", "red"):
            tg_send(
                ...
                "Повітряну тривогу в Березівській громаді та Березівському районі скасовано.\n\n"
